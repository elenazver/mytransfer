...
public class IssueLinkJiraDto {
    ...
    /**
     * The type of connection between tasks (for example, "relates to", "blocks", "duplicates").
     * Represented by the {@link LinkTypeJiraDto} object, which contains information about the type of connection.
     * Example:
     * {
     *   "name": "blocks",
