...
public class RelatedIssueJiraDto {
     ...
     */
    @JsonProperty("id")
    private String id; // ID related tasks
     ...
     */
    @JsonProperty("key")
    private String key; // The key of a related task (for example, "PROJECT-123")
     ...
     */
    @JsonProperty("fields")
    private FieldsJiraDto fields; // Task fields (summary, priority, status)
}