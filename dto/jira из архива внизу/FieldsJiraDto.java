...
public class FieldsJiraDto {
    /**
     * Brief description of the task (subject).
     ...
     * Contains information about the current status of the task.
     * Example: "Open"
     */
    @JsonProperty("status")
    private StatusJiraDto status;
    ...
    private AuthorJiraDto reporter;

    /**
     * Data of the task executor (if assigned).
     * Example:
     * {
    ...
    private AuthorJiraDto assignee;
    ...
    private PriorityJiraDto priority;
    ...
    private List<IssueLinkJiraDto> links;
}